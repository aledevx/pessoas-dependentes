...
namespace pessoa_dependentes_serverside.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public IActionResult PdfExemplo(Guid? id)
        {
            var pessoa = _context.Pessoas.Find(id);

            return new ViewAsPdf(pessoa);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, Pessoa pessoa, Dependente dependente)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
